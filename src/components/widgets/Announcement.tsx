...
const Announcement = () => {
  ...
  return (
    <div className="hidden overflow-hidden text-ellipsis whitespace-nowrap border-b border-gray-800 bg-gray-800 px-3 py-2 text-sm text-gray-200 md:block">
      ...
      {callToAction2 && callToAction2.text && callToAction2.href && (
        ...
        >
          <img
            src="https://img.shields.io/twitter/url/https/twitter.com/lavishmasteriv.svg?style=social&amp;label=Follow%20%40lavishmasteriv"
            alt="Follow @LavishMasterIV"
            width="125"
            height="20"
          />
        </a>
